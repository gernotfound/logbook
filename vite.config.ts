...
export default defineConfig({
  ...
  plugins: [
    ...
    VitePWA({
      ...
      filename: 'sw.ts',
      registerType: 'prompt',
      includeAssets: ['favicon.png', 'favicon.ico', 'apple-touch-icon.png', 'icon-192.png', 'icon-512.png', 'icon-maskable-512.png', 'favicon.svg', 'icons.svg'],
      injectManifest: {
      ...
      manifest: {
        ...
        shortcuts: [
          {
            ...
            url: "/?tab=training",
            icons: [{ src: "icon-192.png?v=20260923", sizes: "192x192", type: "image/png" }]
          },
          {
            name: "Alimentazione",
        ...
        icons: [
          {
            src: 'icon-192.png?v=20260923',
            sizes: '192x192',
            type: 'image/png'
          },
          {
            src: 'icon-512.png?v=20260923',
            sizes: '512x512',
            type: 'image/png'
          },
          {
            src: 'icon-maskable-512.png?v=20260923',
            sizes: '512x512',
            type: 'image/png',
            purpose: 'maskable'
          }
