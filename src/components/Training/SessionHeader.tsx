        ...
        <React.Fragment>
            ...
            {isEditingHistory && (
                <div style={{
                    ...
                    <div>
                        <div style={{ fontWeight: 'bold', color: 'var(--warning-color, #eab308)', fontSize: '0.95rem', display: 'flex', alignItems: 'center', gap: '6px' }}>
                            <Pencil size={16} /> Modifica allenamento dello storico
                        </div>
