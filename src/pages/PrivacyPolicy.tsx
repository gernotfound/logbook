      ...
      <div style={{
        ...
        <div style={{
          ...
          <Section title="Conservazione, backup e cancellazione dei dati">
            ...
            <p>
              I dati applicativi cloud associati all'account vengono conservati per fornire il servizio finché l'account rimane attivo, salvo cancellazioni o obblighi diversi applicabili. La telemetria tecnica privata viene resa idonea alla cancellazione automatica dopo 30 giorni dall'evento oppure, per gli errori aggregati, dall'ultima occorrenza registrata; il servizio Firestore può completare la cancellazione con un ulteriore ritardo tecnico. LogBook mette a disposizione backup JSON ed esportazioni CSV per consentire all'utente di conservare una copia dei propri dati.
            </p>
            <p>
