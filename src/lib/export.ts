...
export const Exporter = {
    async exportToCSV(history: any[], nutrition: Record<string, any>, library: any[] = []) {
        ...
        let nutritionCsv = "Data,Peso (kg),Kcal,Carbo (g),Pro (g),Grassi (g),BF (%),Torace (cm),Spalle (cm),Braccia (cm),Cosce (cm),Polpacci (cm),Note\n";
        ...
        nutritionDates.forEach(date => {
            ...
            nutritionCsv += `${date},${n.weight || ''},${n.kcal || ''},${n.carbs || ''},${n.pro || ''},${n.fat || ''},${n.bf || ''},${n.chest || ''},${n.shoulders || ''},${n.biceps || ''},${n.thighs || ''},${n.calves || ''},${notes}\n`;
        });
