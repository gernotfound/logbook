...
export const MUSCLES: MuscleDef[] = [
    ...
    { id: "lats_upper", name: "Gran dorsale superiore" },
    { id: "lats_upper_right", name: "Gran dorsale superiore destro" },
    { id: "lats_upper_left", name: "Gran dorsale superiore sinistro" },
    { id: "lats_lower", name: "Gran dorsale inferiore" },
    { id: "lats_lower_right", name: "Gran dorsale inferiore destro" },
    { id: "lats_lower_left", name: "Gran dorsale inferiore sinistro" },
...
export const GROUP_MAP: Record<string, string[]> = {
    ...
    'lats': ['lats-upper-left', 'lats-upper-right', 'lats-lower-left', 'lats-lower-right', 'lats-mid-left', 'lats-mid-right'],
    'lats_left': ['lats-upper-left', 'lats-lower-left', 'lats-mid-left'],
    'lats_right': ['lats-upper-right', 'lats-lower-right', 'lats-mid-right'],
    'lats_upper': ['lats-upper-left', 'lats-upper-right'],
    'lats_upper_left': ['lats-upper-left'],
    'lats_upper_right': ['lats-upper-right'],
    'lats_lower': ['lats-mid-left', 'lats-mid-right', 'lats-lower-left', 'lats-lower-right'],
    'lats_lower_left': ['lats-mid-left', 'lats-lower-left'],
    'lats_lower_right': ['lats-mid-right', 'lats-lower-right'],
