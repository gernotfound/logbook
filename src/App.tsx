    ...
    return (
      <div id="auth-overlay">
        <div id="auth-login-box" style={{ textAlign: 'center', maxWidth: '400px', padding: '30px', background: 'rgba(30, 41, 59, 0.7)', backdropFilter: 'blur(10px)', borderRadius: '20px', border: '1px solid rgba(255,255,255,0.1)', boxShadow: '0 10px 40px rgba(0,0,0,0.5)'}}>
            ...
            <button id="btn-login-google" className="btn btn-primary" style={{fontSize: '1.1rem', padding: '15px', width: '100%'}} onClick={login}>
            ...
            <p style={{ marginTop: '12px', fontSize: '0.75rem', color: 'var(--text-muted)', lineHeight: 1.4 }}>
                I dati saranno salvati solo su questo dispositivo. Potrai collegare Google in qualsiasi momento.
            </p>
        </div>
      </div>
    );
